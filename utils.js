...
// محتوى المستخدم ده لازم يتخفي لو الأدمن حظره (عالميًا، على الكل) أو
// لو انت شخصيًا كتمته (خاص بيك بس — mutedPubkeys، شوف bookmarks-mute.js).
function isHidden(pubkey) {
    return bannedPubkeys.has(pubkey) || (typeof mutedPubkeys !== 'undefined' && mutedPubkeys.has(pubkey));
}
